...
-- 문자인코딩 UTF-8 : 영어, 숫자 1BYTE, 한글, 특수문자등은 3BYTE 취급
...
--   테이블 생성 시 해당 컬럼에 지정된 DEFAULT값으로 삽입된다.
...
-- 추가 샘플 데이터 삽입
-- 가입일 -> SYSDATE를 활용
INSERT INTO "MEMBER" VALUES ('MEM02', 'QWER1234', '이순신', '970505-2345678', SYSDATE);
...
-- '2022-09-13 17:33:27'
INSERT INTO "MEMBER" VALUES('MEM05', '1Q2W3E4R', '토르', '930305-1903098',
...
INSERT INTO MEMBER2 VALUES('MEM02', 'PASS02', '홍길순', 01012345678); -- 맨앞에 0이 사라짐
...
-- ORA-01400: NULL을 ("KH_KYH"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
--------------------------------------------------------------------------------------------------------------------
...
-- ORA-00001: 무결성 제약 조건(KH_KYH.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("KH_KYH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
-- 부모 테이블인 USER_GRADE3에서 GRADE_CODE3 =10 삭제
...
-- ORA-02290: 체크 제약조건(KH_KYH.GENDER_CHECK)이 위배되었습니다
...
CREATE TABLE USER_TEST (
	...
	PHONE CHAR(11),
	ADDRESS VARCHAR(50),
	STATUS CHAR(1) DEFAULT 'N' CONSTRAINT NN_STATUS NOT NULL CONSTRAINT CK_STATUS CHECK(STATUS IN('Y', 'N')) 
);
COMMIT;
...
ALTER TABLE LOCATION ADD CONSTRAINT LOCATION_NATIONAL_CODE
